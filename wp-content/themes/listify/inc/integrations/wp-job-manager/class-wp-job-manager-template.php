...
<div class="job_listing-directions">
	...
	<div class="job_listing-get-directions" id="get-directions-form">
		<form class="job-manager-form" action="https://maps.google.com/maps">
...
<?php
    ...
    public function get_grid_columns( $style = false ) {
        ...
        if ( 
			( 
				'side' == $listify_job_manager->map->template->position() ||
				'side' == get_theme_mod( 'listing-archive-facetwp-position', 'side' ) ||
...
<?php
	...
	public function get_the_company_logo( $args = array() ) {
		...
		$logo = $args[ 'listing' ]->_company_avatar;
...
<?php
	...
	public function get_the_company_avatar( $args ) {
		...
		if ( $gravatar ) {
			...
			$gravatar = isset( $matches[1] ) ? $matches[1] : '';
		}
