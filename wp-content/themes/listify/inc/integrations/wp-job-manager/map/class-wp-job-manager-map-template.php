...
class Listify_WP_Job_Manager_Map_Template extends listify_Integration {
	...
	public function display() {
		$display = listify_theme_mod( 'listing-archive-output', 'map-results' );

		return in_array( $display, array( 'map', 'map-results' ) ) && get_theme_mod( 'map-behavior-api-key', false );
	}
	...
	public function position() {
		return listify_theme_mod( 'listing-archive-map-position', 'side' );
	}
	...
	public function register_scripts() {
        ...
        if ( listify_theme_mod( 'map-behavior-api-key', false ) ) {
            $args[ 'key' ] = listify_theme_mod( 'map-behavior-api-key', false );
        }
		...
		wp_register_script( 'google-maps', esc_url_raw( add_query_arg( $args, $base ) ), array(), null, false );
