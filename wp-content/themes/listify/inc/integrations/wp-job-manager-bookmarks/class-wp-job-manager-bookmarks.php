...
class Listify_WP_Job_Manager_Bookmarks extends Listify_Integration {
	...
	public function setup_actions() {
		...
		add_action( 'single_job_listing_meta_after', array( $this, 'output_count' ) );
	...
	public function output_count() {
		global $job_manager_bookmarks, $post;
		...
		printf( '<span class="wp-job-manager-bookmarks-count">' . _n( '%d Favorite', '%d Favorites', $count, 'listify' ), $count ) . '</span>';
	}
