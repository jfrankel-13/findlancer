...
get_header(); ?>
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<?php if ( 'none' !== $style ) : ?>
			...
			<div <?php echo apply_filters( 'listify_cover', 'homepage-cover page-cover entry-cover entry-cover--home entry-cover--' . get_theme_mod( 'home-hero-overlay-style', 'gradient' ), array( 'size' =>
			'full' ) ); ?>>
